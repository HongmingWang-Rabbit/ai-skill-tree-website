...
- **Resume Export**: Generate professional PDF resumes tailored to specific jobs. Just paste a job posting URL for AI-optimized content. Preview the PDF before downloading. Free tier exports include a watermark; Pro/Premium tiers get clean PDFs.
...
│   │   ├── ResumeExportModal.tsx # Multi-stage resume generation modal with PDF preview
│   │   ├── PDFPreviewPanel.tsx # Inline PDF viewer using PDFViewer (SSR-safe)
...
RESUME_CONFIG.pdfLabels.watermarkMain   // Main watermark text ("SKILL MAP")
RESUME_CONFIG.pdfLabels.watermarkSub    // Secondary watermark text
