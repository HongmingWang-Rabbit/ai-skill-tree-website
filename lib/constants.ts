...
// Note: LinkedIn and Indeed are JS-rendered and require Tavily search
export const JOB_BOARD_CONFIG = {
  // Domains that require Tavily search instead of direct scraping
  tavilySearchDomains: ['linkedin.com', 'indeed.com'],
} as const;
